    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_activity', models.DateField(blank=True, null=True, verbose_name='Last activity')),
                ('event_tracking_id', models.UUIDField(default=uuid.uuid4, unique=True, verbose_name='Event Tracking ID')),
            ...
            managers=[
                ('objects', core.managers.UsersManager()),
            ],
        ),
    ]
